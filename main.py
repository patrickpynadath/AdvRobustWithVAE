...
if __name__ == '__main__':
    ...
    trainer = Trainer(gpus=1, auto_select_gpus=True, fast_dev_run=False, enable_progress_bar=True, max_epochs=MAX_EPOCHS, logger=logger)
    resnet = LightningResnet(depth=20, num_classes=10, block_name='BottleNeck')
