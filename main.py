...
if __name__ == '__main__':
    ...
    trainer = Trainer(gpus=2, auto_select_gpus=True, fast_dev_run=False, enable_progress_bar=True, max_epochs=MAX_EPOCHS, logger=logger, log_every_n_steps=10, flush_logs_every_n_steps=10)
