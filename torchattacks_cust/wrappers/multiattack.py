...
class MultiAttack(Attack):
    ...
    Examples::
        >>> atk1 = torchattacks_cust.PGD(model, eps=8/255, alpha=2/255, iters=40, random_start=True)
        >>> atk2 = torchattacks_cust.PGD(model, eps=8/255, alpha=2/255, iters=40, random_start=True)
        >>> atk = torchattacks_cust.MultiAttack([atk1, atk2])
